...
export function withInstall<T, E extends Record<string, unknown>>(component: T, extra?: E): SFCWithInstall<T> {
	/* c8 ignore next */
...
export function withFunctionInstall<T>(component: T, name: string): SFCInstallWithContext<T> {
	/* c8 ignore next */
